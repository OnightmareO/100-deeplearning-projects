...
from data import HandGestureDataset
from utils import get_mean_std, get_transformations,get_dataloader
import torch.nn as nn
import torch.optim as optim
import os
from model import InceptionV3_224
hand_data = HandGestureDataset('./data/gestures')
mean, std = get_mean_std(hand_data)
...
print('Load model ...')
model = InceptionV3_224(num_classes=26,aux_logits=True, dropout=0.3).to(device)
...
torch.save(model.state_dict(),'./models/13.hand_identifier.pth')
print("Saved best model to ./models/13.hand_identifier.pth")
