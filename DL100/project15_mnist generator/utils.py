...
def save_model(model,epoch,save_dir= './models/',model_name='15gan_mnist.pth'):
...
def load_model(model, model_dir='./models/', model_name='15gan_mnist.pth'):
...
def save_images(images, epoch, folder='./data/15_gan_generated/', prefix='generated'):
