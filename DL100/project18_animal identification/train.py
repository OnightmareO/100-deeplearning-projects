...
animal_data = AnimalDataset('./data/animal_data')
mean, std = get_mean_std(animal_data)
...
print('Load model ...')
model = Xception(num_classes=4).to(device)
...
torch.save(model.state_dict(),'./models/18.animal_identifier.pth')
print("Saved best model to ./models/18.animal_identifier.pth")
