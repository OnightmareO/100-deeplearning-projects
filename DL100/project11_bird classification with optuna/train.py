...
best_params = {
    ...
    'kernel_size_2': 3,
    'kernel_size_3': 5,
    'dropout_rate': 0.24097277282650198,
    'fc_size': 1323,
}
...
torch.save(model.state_dict(), './models/11.bird_classifier_with_optuna.pth')
print("Saved best model to ./models/11.bird_classifier_with_optuna.pth")
